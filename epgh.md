...
【明慧網二零一八年四月十日】四月七日上午發現，韓五A新唐人只有信號，沒有圖象和聲音。天地行論壇衛星技術版也有不少反饋。後來在新唐人原頻道增加節目，出現了圖象和聲音。查看參數，發現是韓五A新唐人視頻、音頻和時鐘PID更改造成的。這次更改參數沒有預警，新唐人總部也沒有發布公告，這次是臨時更改參數，還是長期的也不清楚，所以我們這次調整參數，建議保存原來的參數頻道，這樣如果參數再調整回來就不用再調整了。以下三種方法使用任一種方法都可以解決問題，解決方法建議使用方法一或二，這兩種方法既能收看到新唐人，又能保存原來的參數頻道。
這次調整下行頻率和符號率沒有變：下行頻率：12618 符號率：03900
...
一：在新唐人原頻道增加節目（推薦，最簡單）：菜單──節目設置──增加節目──模式免費──確定

二：自動搜索：菜單──節目設置──自動搜索──設置本質頻率（11300或10750或10600）──搜索模式──免費──22K（雙星設置為開，單星本振10600的高頻頭設置為開，其它不用管）──確定

三：節目參數設置：在新唐人原頻道上──菜單──節目設置──節目參數設置──將原視頻PID：0257、聲音PID：0258、時鐘PID：0257更改為：視頻PID：0256、聲音PID：4112、時鐘PID：0513──確定
